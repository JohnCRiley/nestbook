...
const MODAL_T = {
  en: {
    ...
    freeFeatures: [
      ...
      'Your own property webpage — 3 photos per room + contact form',
      'Facebook Action Button + slug editor',
    ...
    proFeatures: [
      ...
      { icon: '📧', name: 'Guest Mailer',
        desc: 'Send a branded email to past or future guests — promote a special offer, share news about your property, or send a seasonal greeting. Emails arrive under your property name and logo.' },
      { icon: '⭐', name: 'Automatic Review Requests',
        desc: 'After check-out, NestBook automatically emails your guest a polite review request with a link to your Google or TripAdvisor page. Configurable delay, zero effort from you.' },
      { icon: '📝', name: 'Guest Notes',
        desc: 'After their stay, guests can leave a private note for you — honest feedback that arrives directly without affecting your public star rating on any platform.' },
    ],
    multiFeatures: [
  ...
  fr: {
    ...
    freeFeatures: [
      ...
      'Votre propre page web — 3 photos par chambre + formulaire de contact',
      "Bouton d'action Facebook + éditeur de lien",
      ...
      '5 langues',
      'Kit réseaux sociaux',
      'Guide de configuration Facebook & Instagram',
      'QR code & codes WiFi de réservation',
    ...
    proFeatures: [
      ...
      { icon: '📧', name: 'Mailer clients',
        desc: 'Envoyez un e-mail personnalisé à vos anciens ou futurs clients — pour une offre spéciale, des nouvelles ou un vœu de saison. Les e-mails sont envoyés sous le nom et le logo de votre établissement.' },
      { icon: '⭐', name: 'Demandes d\'avis automatiques',
        desc: 'Après le départ, NestBook envoie automatiquement une demande d\'avis avec un lien vers votre page Google ou TripAdvisor. Délai configurable, aucun effort de votre part.' },
      { icon: '📝', name: 'Notes clients',
        desc: 'Après leur séjour, vos clients peuvent vous laisser une note privée — un retour honnête qui vous parvient sans affecter votre note publique sur aucune plateforme.' },
    ],
    multiFeatures: [
  ...
  es: {
    ...
    freeFeatures: [
      ...
      'Su propia página web — 3 fotos por habitación + formulario de contacto',
      'Botón de acción de Facebook + editor de enlace',
      ...
      'Guía de configuración Facebook e Instagram',
      'QR de página de reserva y códigos WiFi',
      'Banner de ofertas',
    ...
    proFeatures: [
      ...
      { icon: '📧', name: 'Mailer de huéspedes',
        desc: 'Envíe un correo personalizado a huéspedes pasados o futuros — para una oferta especial, noticias o un saludo festivo. Los correos se envían con el nombre y logotipo de su propiedad.' },
      { icon: '⭐', name: 'Solicitudes de reseñas automáticas',
        desc: 'Tras el check-out, NestBook envía automáticamente una solicitud de reseña con enlace a su página de Google o TripAdvisor. Retraso configurable, ningún esfuerzo de su parte.' },
      { icon: '📝', name: 'Notas de huéspedes',
        desc: 'Tras su estancia, los huéspedes pueden dejarle una nota privada — comentarios honestos que le llegan sin afectar su calificación pública en ninguna plataforma.' },
    ],
    multiFeatures: [
  ...
  de: {
    ...
    freeFeatures: [
      ...
      'Eigene Webseite — 3 Fotos pro Zimmer + Kontaktformular',
      'Facebook-Aktionsschaltfläche + Link-Editor',
      ...
      '5 Sprachen',
      'Social-Media-Kit',
      'Facebook & Instagram Einrichtungsleitfaden',
      'QR-Code & WLAN-Codes für Buchungsseite',
      'Angebots-Banner',
    ...
    proFeatures: [
      ...
      { icon: '📧', name: 'Gäste-Mailer',
        desc: 'Senden Sie eine personalisierte E-Mail an vergangene oder zukünftige Gäste — für ein Sonderangebot, Neuigkeiten oder einen saisonalen Gruß. E-Mails kommen unter dem Namen und Logo Ihrer Unterkunft an.' },
      { icon: '⭐', name: 'Automatische Bewertungsanfragen',
        desc: 'Nach dem Check-out sendet NestBook automatisch eine höfliche Bewertungsanfrage mit einem Link zu Ihrer Google- oder TripAdvisor-Seite. Konfigurierbarer Zeitpunkt, kein Aufwand Ihrerseits.' },
      { icon: '📝', name: 'Gästenachrichten',
        desc: 'Nach ihrem Aufenthalt können Gäste Ihnen eine private Nachricht hinterlassen — ehrliches Feedback, das direkt zu Ihnen kommt, ohne Ihre öffentliche Bewertung zu beeinflussen.' },
    ],
    multiFeatures: [
  ...
  nl: {
    ...
    freeFeatures: [
      ...
      "Eigen webpagina — 3 foto's per kamer + contactformulier",
      'Facebook actieknop + link-editor',
      ...
      '5 talen',
      'Social Media Kit',
      'Facebook & Instagram installatiegids',
      'QR-code & WiFi-codes boekingspagina',
      'Aanbiedingsbanner',
    ...
    proFeatures: [
      ...
      { icon: '📧', name: 'Gastmailer',
        desc: 'Stuur een gepersonaliseerde e-mail naar vroegere of toekomstige gasten — voor een speciale aanbieding, nieuws of een seizoensgroet. E-mails komen aan onder de naam en het logo van uw accommodatie.' },
      { icon: '⭐', name: 'Automatische beoordelingsverzoeken',
        desc: 'Na het uitchecken stuurt NestBook automatisch een beleefde beoordelingsaanvraag met een link naar uw Google- of TripAdvisor-pagina. Instelbare vertraging, geen moeite van uw kant.' },
      { icon: '📝', name: 'Gastnotities',
        desc: 'Na hun verblijf kunnen gasten u een privébericht achterlaten — eerlijke feedback die direct bij u aankomt zonder uw openbare beoordeling op enig platform te beïnvloeden.' },
    ],
    multiFeatures: [
