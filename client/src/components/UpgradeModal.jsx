...
const MODAL_T = {
  en: {
    ...
    proFeatures: [
      ...
      { icon: '🍳', name: 'Breakfast Management',
        desc: 'Track which guests have breakfast included, which are paying, and how many mornings. Added automatically to the checkout bill and printed receipt.' },
  ...
  fr: {
    ...
    proFeatures: [
      ...
      { icon: '🍳', name: 'Gestion des petits-déjeuners',
        desc: 'Suivez quels hôtes ont le petit-déjeuner inclus, lesquels le paient, et combien de matins. Ajouté automatiquement à la note de départ et au reçu imprimé.' },
  ...
  es: {
    ...
    proFeatures: [
      ...
      { icon: '🍳', name: 'Gestión del desayuno',
        desc: 'Controle qué huéspedes tienen el desayuno incluido, cuáles lo pagan y cuántos días. Se añade automáticamente a la factura de salida y al recibo impreso.' },
  ...
  de: {
    ...
    proFeatures: [
      ...
      { icon: '🍳', name: 'Frühstücksverwaltung',
        desc: 'Behalten Sie im Blick, welche Gäste Frühstück inklusive haben, wer es bezahlt und an wie vielen Morgen. Es wird automatisch zur Checkout-Rechnung und zum gedruckten Beleg hinzugefügt.' },
  ...
  nl: {
    ...
    proFeatures: [
      ...
      { icon: '🍳', name: 'Ontbijtbeheer',
        desc: 'Houd bij welke gasten ontbijt hebben inbegrepen, welke het betalen en hoeveel ochtenden. Automatisch toegevoegd aan de uitcheckrekening en het gedrukte bonnetje.' },
