...
const MODAL_T = {
  en: {
    ...
    proFeatures: [
      ...
      { icon: '📸', name: '5 Photos per Room',
        desc: 'Showcase each room with up to 5 photos on your property page and booking widget. More photos means guests feel confident before they book — fewer questions, better conversions.' },
  ...
  fr: {
    ...
    freeFeatures: [
      ...
      "Votre page d'hébergement NestBook",
    ...
    proFeatures: [
      ...
      { icon: '📸', name: '5 photos par chambre',
        desc: 'Valorisez chaque chambre avec jusqu\'à 5 photos sur votre page et votre widget. Plus de photos, c\'est plus de confiance avant la réservation — moins de questions, plus de conversions.' },
  ...
  es: {
    ...
    proFeatures: [
      ...
      { icon: '📸', name: '5 fotos por habitación',
        desc: 'Muestre cada habitación con hasta 5 fotos en su página y widget. Más fotos significa más confianza antes de reservar — menos preguntas, mejores conversiones.' },
  ...
  de: {
    ...
    freeFeatures: [
      ...
      'Ihre NestBook-Unterkunftsseite',
    ...
    proFeatures: [
      ...
      { icon: '📸', name: '5 Fotos pro Zimmer',
        desc: 'Präsentieren Sie jedes Zimmer mit bis zu 5 Fotos auf Ihrer Seite und Ihrem Widget. Mehr Fotos bedeuten mehr Vertrauen vor der Buchung — weniger Rückfragen, bessere Konversionen.' },
  ...
  nl: {
    ...
    freeFeatures: [
      ...
      'Uw NestBook-accommodatiepagina',
    ...
    proFeatures: [
      ...
      { icon: '📸', name: '5 foto\'s per kamer',
        desc: 'Toon elke kamer met maximaal 5 foto\'s op uw pagina en widget. Meer foto\'s betekent meer vertrouwen voor het boeken — minder vragen, betere conversies.' },
