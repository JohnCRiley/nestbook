    ...
    <div style={{ height: '100%', overflowY: 'auto', background: '#f3f7f2', color: '#1a2e14', display: 'flex', flexDirection: 'column' }}>
      ...
      <div style={{ flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '40px 20px 60px' }}>
        <div style={{ width: '100%', maxWidth: 520 }}>
          ...
          {showPreamble ? (
            /* ── Preamble screen — no dots ── */
            <>
              <h2 style={{ fontSize: '1.4rem', fontWeight: 800, color: '#1a2e14', marginBottom: 28, textAlign: 'center', letterSpacing: '-0.3px', lineHeight: 1.3 }}>
                Thank you for choosing to sign up with NestBook.
              </h2>

              <p style={paraStyle}>
                If you are just curious and want to look around – please feel free to do so.
              </p>
              <p style={paraStyle}>
                When submitting your details, you will need to verify your email address for security reasons. You will then only be asked for one or two pieces of basic information.
              </p>
              <p style={paraStyle}>
                As you are signing up for the free plan, we will not ask for any payment details. If the free plan suits your needs, please use it freely, for as long as you wish.
              </p>
              <p style={{ ...paraStyle, marginBottom: 32 }}>
                If you wish to upgrade your plan, you'll be forwarded to a secure Stripe payment gateway. You will be asked to input payment details but will not be charged. You will have 30 days trial period before any payment is taken. You may cancel at any time.
              </p>

              <button className="btn-wiz" onClick={() => setShowPreamble(false)}>
                Continue to sign-up
              </button>
            ...
            /* ── Steps 0–2 with progress dots ── */
            <>
              {/* Progress dots */}
              <div className="wizard-steps" style={{ justifyContent: 'center', marginBottom: 28 }}>
                {[0, 1, 2].map(i => (
                  <div
                    key={i}
                    ...
                    style={{
                      ...
                      ...(i > step ? { background: '#fff', borderColor: '#b3d9a3' } : {}),
                    }}
