...
const T = {
  en: {
    ...
    onboardStep5Title:  'Add an action button to your Facebook page',
    onboardStep5Body:   'This is the step most owners love. In Settings, scroll to Facebook Action Button — you\'ll find a step-by-step guide showing exactly how to add a button to your Facebook business page that links straight to your booking page.',
  ...
  fr: {
    ...
    onboardStep5Title:  "Ajoutez un bouton d'action à votre page Facebook",
    onboardStep5Body:   "Dans Paramètres, trouvez Bouton d'action Facebook — vous trouverez un guide détaillé, étape par étape, vous montrant exactement comment ajouter un bouton à votre page Facebook qui renvoie directement vers votre page de réservation.",
  ...
  es: {
    ...
    onboardStep5Title:  'Añada un botón de acción a su página de Facebook',
    onboardStep5Body:   'En Configuración, encuentre Botón de acción de Facebook — encontrará una guía paso a paso que muestra exactamente cómo añadir un botón a su página de Facebook que enlace directamente con su página de reservas.',
  ...
  de: {
    ...
    onboardStep5Title:  'Aktionsschaltfläche zu Ihrer Facebook-Seite hinzufügen',
    onboardStep5Body:   'Finden Sie in den Einstellungen Facebook-Aktionsschaltfläche — mit einer Schritt-für-Schritt-Anleitung, die genau zeigt, wie Sie einen Button zu Ihrer Facebook-Seite hinzufügen, der direkt auf Ihre Buchungsseite verlinkt.',
  ...
  nl: {
    ...
    onboardStep5Title:  'Voeg een actieknop toe aan uw Facebook-pagina',
    onboardStep5Body:   'Vind in Instellingen Facebook actieknop — u vindt een stapsgewijze handleiding die precies laat zien hoe u een knop aan uw Facebook-pagina toevoegt die rechtstreeks naar uw boekingspagina linkt.',
